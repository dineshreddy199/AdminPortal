...
import '../../component/Style/AddEmployee.css';

const AddResignationDetails = () => {
  const API_BASE_URL = 'http://localhost:5000/hrResign';
  ...
  navigate('/RegistationDetails');
};


  return (
    <><div>
        <Link to="/RegistationDetails">
          <button
            type="button"
...
export default AddResignationDetails;
