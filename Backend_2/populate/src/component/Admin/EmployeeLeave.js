...
const EmployeeLeave = () => {
  const API_BASE_URL = 'http://localhost:5000/employeeLeave';
...
const handleEdit = (employee) => {
  navigate('/AddEmployeeLeave', { state: { employee } });
};
  ...
  return (
    <>
      ...
      <div className='Nav-txt' style={{position:"absolute",top:"2.15rem"}}>List Of Employee Details</div>

      {/* <div>
        <Link to="/AddEmployeeLeave">
          <button
            type="button"
      ...
      <div className='Main-Box'>
        ...
        <div className='SearchBar'>
          <input
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value) } className='SearchBar-in'
